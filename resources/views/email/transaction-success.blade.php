                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:180px;"> <img alt="" height="auto"
                                                                src="{{asset('frontend/images/logo_nomads.png')}}"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Playfair Display, Time New Roman, Serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071C4D;">
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:550px;"> <img alt="" height="auto"
                                                                ...
                                                                <tr>
                                                                    <td align="center" bgcolor="#FF9E53"
                                                                      ...
                                                                      <a href="{{url('checkout/'.$data->id)}}"
                                                                            style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Assistant, Halvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;">
                                                                            Check Detail </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                ...
                                                2019 LUGs Copyright All Rights Reserved.</div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
